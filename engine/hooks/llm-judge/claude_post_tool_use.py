...
from detect import detect_claude_post_tool_use as detect  # noqa: E402
...
def main() -> None:
    try:
        run_hook("llm-judge", "claude", detect, hook_event_name="PostToolUse", json_error_message=_json_error)
    except SystemExit:
