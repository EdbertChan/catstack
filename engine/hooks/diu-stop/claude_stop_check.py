...
diu_limits.py if that gets annoying; the pre-write reminder reads the same
definition, so it moves with it.
...
from diu_limits import WORD_LIMIT, word_count as count_words
