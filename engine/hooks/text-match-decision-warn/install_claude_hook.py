#!/usr/bin/env python3
"""Merge text-match-decision-warn's Claude PreToolUse hook into ~/.claude/settings.json without wiping others."""
...
MARKER = "text-match-decision-warn/claude_pretooluse.py"
...
def main() -> None:
    ...
    if before == after:
        print("ok      claude PreToolUse text-match-decision-warn already up to date")
        return
    ...
    with open(SETTINGS_PATH, "w") as f:
        ...
        f.write("\n")
    print("link    claude PreToolUse text-match-decision-warn merged")
