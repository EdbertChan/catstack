#!/usr/bin/env python3
"""Merge pr-schema-gate's Claude PreToolUse hook into ~/.claude/settings.json without wiping others."""
...
def main() -> None:
    ...
    if before == after:
        print("ok      claude PreToolUse pr-schema-gate already up to date")
        return
    ...
    with open(SETTINGS_PATH, "w") as f:
        ...
        f.write("\n")
    print("link    claude PreToolUse pr-schema-gate merged")
