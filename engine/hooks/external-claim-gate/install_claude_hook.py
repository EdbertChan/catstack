...
MARKER = "external-claim-gate/claude_pretooluse.py"
...
def main() -> None:
    ...
    if before == after:
        print("ok      claude PreToolUse external-claim-gate already up to date")
        return
    ...
    with open(SETTINGS_PATH, "w") as f:
        ...
        f.write("\n")
    print("link    claude PreToolUse external-claim-gate merged")
