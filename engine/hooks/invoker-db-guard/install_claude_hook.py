#!/usr/bin/env python3
"""Merge invoker-db-guard's Claude PreToolUse (Bash) hook into
...
MARKER = "invoker-db-guard/claude_pretooluse.py"
...
def main() -> None:
    ...
    with open(SETTINGS_PATH, "w") as handle:
        ...
        handle.write("\n")
    print("link    claude PreToolUse invoker-db-guard merged")
