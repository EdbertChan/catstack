...
```sh
export CATSTACK_EXPLICIT_FAILURES=1
touch .explicit-failures        # at the repo root; any parent of the tool cwd works
```

`CATSTACK_EXPLICIT_FAILURES=0` forces it off even with a marker present.
