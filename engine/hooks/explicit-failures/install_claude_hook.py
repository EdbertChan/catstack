#!/usr/bin/env python3
"""Merge explicit-failures's Claude PreToolUse hook into ~/.claude/settings.json without wiping others."""
...
MARKER = "explicit-failures/claude_pretooluse.py"
...
def main() -> None:
    ...
    if before == after:
        print("ok      claude PreToolUse explicit-failures already up to date")
        return
    ...
    with open(SETTINGS_PATH, "w") as f:
        ...
        f.write("\n")
    print("link    claude PreToolUse explicit-failures merged")
