...
- NOT DETERMINISTIC: whether the model chooses a given skill. That needs a
  ...
  script can honestly check, so it does not pretend to.
    ...
    python3 scripts/test/run_skill_scenarios.py --only fix-claim-no-evidence
    python3 scripts/test/run_skill_scenarios.py --list
    python3 scripts/test/run_skill_scenarios.py -v      # show each hook's message
"""
