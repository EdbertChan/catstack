...
"""Replay one detector over real local transcripts and report what it catches.
    ...
    python3 scripts/test/backtest_detector.py --detector PATH:CALLABLE [--unit UNIT]
        [--limit N] [--verbose] [--json OUT] [TRANSCRIPT_OR_DIR ...]
    python3 scripts/test/backtest_detector.py --detector PATH:CALLABLE --compare REF
    python3 scripts/test/backtest_detector.py --detector PATH:CALLABLE --compare OTHER_PATH[:CALLABLE]
