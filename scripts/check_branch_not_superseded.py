...
GATE_EXEMPLARS: dict[str, list[dict]] = {
    "catch": [
        _evidence(ahead=1, behind=4, unique_commits=0, additions=82, deletions=1257,
                  files_differ=32, files_behind=32),
        _evidence(ahead=0, behind=9, unique_commits=0, deletions=400, files_differ=12, files_behind=12),
        _evidence(ahead=2, behind=18, unique_commits=2, additions=192, deletions=7207,
                  files_differ=118, files_behind=118),
        _evidence(ahead=3, behind=183, unique_commits=2, additions=849, deletions=38370, binary_files=15,
                  files_differ=573, files_behind=573, added_lines_missing_from_base=2),
        _evidence(ahead=2, behind=6, unique_commits=2, additions=4, deletions=120,
                  files_differ=9, files_behind=8),
    ],
    "allow": [
        _evidence(additions=40, deletions=2, files_differ=2, added_lines_missing_from_base=40),
        _evidence(behind=30, additions=12, deletions=900, files_differ=25, files_behind=24,
                  added_lines_missing_from_base=12),
        _evidence(behind=30, deletions=950, files_differ=26, files_behind=25, removed_lines_still_on_base=60),
        _evidence(behind=30, additions=3, deletions=950, files_differ=26, files_behind=25,
                  binary_files=1, unreadable_branch_files=1),
    ],
}
...
def gate_check(exemplar: dict) -> bool:
    return classify(Evidence(**exemplar))[0] == SUPERSEDED
