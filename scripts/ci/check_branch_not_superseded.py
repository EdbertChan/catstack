...
Refuses, UNCHECKED, exit 2:
  - the ref or base does not resolve, a pull ref cannot be fetched, the
    ...
    python3 scripts/ci/check_branch_not_superseded.py <branch>
    python3 scripts/ci/check_branch_not_superseded.py '#<number>' --base origin/main
    python3 scripts/ci/check_branch_not_superseded.py <branch> --repo <clone> --json
"""
