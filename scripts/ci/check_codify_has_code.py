...
not count even though its suffix is .json or .yaml.
    ...
    python3 scripts/ci/check_codify_has_code.py                # diff vs origin/main
    python3 scripts/ci/check_codify_has_code.py --base main
    python3 scripts/ci/check_codify_has_code.py --allow-prose-only   # doc-only PR, explicit
