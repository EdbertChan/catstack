...
edit to this file.
    ...
    python3 scripts/pr/plan_preflight.py --paths corpus/skills/x/SKILL.md scripts/y.py
    python3 scripts/pr/plan_preflight.py --paths ... --base origin/main
    python3 scripts/pr/plan_preflight.py --paths ... --json
"""
