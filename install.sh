...
link_item "unverified-tag-check" "$REPO_DIR/engine/hooks/unverified-tag-check" "$HOME/.cursor/hooks/unverified-tag-check"
...
link_item "unverified-tag-check" "$REPO_DIR/engine/hooks/unverified-tag-check" "$HOME/.codex/hooks/unverified-tag-check"
