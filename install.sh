...
link_item "handback-needs-attempt" "$REPO_DIR/engine/hooks/handback-needs-attempt" "$HOME/.cursor/hooks/handback-needs-attempt"
...
link_item "handback-needs-attempt" "$REPO_DIR/engine/hooks/handback-needs-attempt" "$HOME/.codex/hooks/handback-needs-attempt"
