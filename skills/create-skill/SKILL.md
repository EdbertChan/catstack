...
- Prefer putting portable skills in this repo under `skills/<name>/` and
  running `./install.sh`. That is the only path that keeps all three roots
...
1. Create `skills/<name>/SKILL.md` (agent-agnostic prose).
