...
OWN_REPO_ROOT = os.path.dirname(os.path.dirname(HERE))
...
RELEVANT_PREFIXES = ("hooks/", "skills/", "cursor/", "commands/", "always-on/", "docs/", ".github/workflows/")
...
INSTRUCTION = (
    ...
    "(3) for every touched hooks/<name>/ that has a detect.py, verify or add a positive "
    ...
    "`python3 scripts/check_hook_test_coverage.py hooks/<name>` to confirm; "
